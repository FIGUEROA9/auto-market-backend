...
//#region node_modules/.nitro/vite/services/ssr/assets/middleware-CWNnPn8G.js
...
async function createPgliteSql() {
	...
	const migrate = async () => {
		const migrations = /* #__PURE__ */ Object.assign({
			...
			"/migrations/0003_verificacion_y_papeles.sql": _0003_verificacion_y_papeles_default
		});
...
var authMiddleware = createMiddleware({ type: "function" }).client(async ({ next }) => {
	...
	const { requireUserId } = await import("./verify.server-DG4BGU-U.mjs");
