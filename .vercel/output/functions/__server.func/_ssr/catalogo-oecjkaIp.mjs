...
import { i as CITIES, r as BRANDS } from "./format-CKYgwz_q.mjs";
import { s as Search } from "../_libs/lucide-react.mjs";
import { r as Route$15, w as listVehicles } from "./router-Ih3cAWOQ.mjs";
import { t as SiteShell } from "./site-shell-XNI7BQoO.mjs";
import { t as VehicleCard } from "./vehicle-card-UhQN4o1S.mjs";
import { a as Select, i as Input } from "./input-DDfGu04B.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/catalogo-oecjkaIp.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
function Catalogo() {
	const initial = Route$15.useLoaderData();
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SiteShell, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				children: "Venta directa y permuta. Filtra y entra al detalle para ofertar."
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "mt-8 grid gap-3 rounded-xl border border-border bg-surface p-4 md:grid-cols-5",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Search, { className: "pointer-events-none absolute left-3 top-1/2 size-4 -translate-y-1/2 text-subtle" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input, {
							className: "pl-9",
							placeholder: "Buscar marca, línea o ciudad",
							value: q,
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Select, {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
							value: "",
							children: "Todo tipo de carrocería"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
							value: "sedan",
							children: "Sedán"
