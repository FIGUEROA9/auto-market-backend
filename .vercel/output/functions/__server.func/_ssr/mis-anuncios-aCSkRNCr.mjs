...
import { C as listMyVehicles, E as resubmitVehicle, M as updateVehicleStatus, g as deleteMyVehicle } from "./router-Ih3cAWOQ.mjs";
import { t as SiteShell } from "./site-shell-XNI7BQoO.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/mis-anuncios-aCSkRNCr.js
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					children: "Los nuevos anuncios aparecen como pendientes hasta que un administrador los apruebe."
				})
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							v.status === "rechazado" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
								size: "sm",
								variant: "secondary",
								onClick: async () => {
									await resubmitVehicle({ data: { id: v.id } });
									toast.success("Reenviado a revisión.");
									load();
								},
								children: "Reenviar"
							}),
							v.status !== "vendido" && v.status !== "pendiente" && v.status !== "rechazado" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
								size: "sm",
								variant: "outline",
								onClick: async () => {
									await updateVehicleStatus({ data: {
