...
import { c as STATUS_LABEL, d as formatCop, o as LISTING_LABEL } from "./format-ZWbZZFM2.mjs";
import { t as Button } from "./button-CsbLcD7M.mjs";
import { d as adminSetVehicleStatus, l as adminListVehicles } from "./router-MosyGjip.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/anuncios-pJV1ZEP1.js
...
function Anuncios() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
			...
			children: [rows.length, " publicados."]
		}),
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Badge, {
									tone: v.status === "activo" ? "success" : v.status === "pausado" ? "warn" : "neutral",
