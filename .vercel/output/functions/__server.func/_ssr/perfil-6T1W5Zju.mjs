...
import { r as CITIES } from "./format-BnknwAXq.mjs";
...
import { T as updateMyProfile, g as getMyProfile } from "./router-BALgUNLD.mjs";
import { t as SiteShell } from "./site-shell-CmKuxx-u.mjs";
import { n as Input, r as Select, t as Field } from "./input-Do1Wrx3v.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/perfil-6T1W5Zju.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SiteShell, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
		...
		children: [
			...
			profile && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
				...
				children: ["Rol: ", profile.role === "admin" ? "Administrador" : "Cliente"]
			}),
