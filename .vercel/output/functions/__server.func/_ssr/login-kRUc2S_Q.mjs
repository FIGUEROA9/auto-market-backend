...
import { t as GROK_PROVIDERS } from "./server-ChBHqTAi.mjs";
import { a as useCurrentUserState } from "./gates-DiqTagne.mjs";
import { t as Button } from "./button-CuuAiOA2.mjs";
import { t as SiteShell } from "./site-shell-XNI7BQoO.mjs";
import { i as Input, r as Field } from "./input-DDfGu04B.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/login-kRUc2S_Q.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SiteShell, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				children: "El primer usuario en registrarse obtiene el panel de administración. Al crear la cuenta podrás verificar tu cédula para destacar perfil y anuncios."
			}),
