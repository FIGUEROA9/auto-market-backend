...
//#region node_modules/.nitro/vite/services/ssr/assets/middleware-D67d4Qk4.js
...
async function createPgliteSql() {
	...
	const migrate = async () => {
		const migrations = /* #__PURE__ */ Object.assign({
			...
			"/migrations/0003_moderation.sql": _0003_moderation_default
		});
...
var authMiddleware = createMiddleware({ type: "function" }).client(async ({ next }) => {
	...
	const { requireUserId } = await import("./verify.server-DQrsNf6l.mjs");
