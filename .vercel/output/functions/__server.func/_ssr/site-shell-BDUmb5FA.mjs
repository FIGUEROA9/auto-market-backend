...
import { a as useCurrentUserState, i as UserButton, n as SignedIn, r as SignedOut } from "./gates-7MpIqa07.mjs";
import { m as Menu, o as Tag, r as X, u as RefreshCw, y as Heart } from "../_libs/lucide-react.mjs";
import { t as Button } from "./button-CsbLcD7M.mjs";
import { S as getMyProfile } from "./router-C_w5OZSs.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/site-shell-BDUmb5FA.js
...
function SiteHeader() {
	...
	(0, import_react.useEffect)(() => {
		...
		getMyProfile().then((p) => setIsAdmin(p?.role === "admin")).catch(() => setIsAdmin(false));
	}, [user, isPending]);
	(0, import_react.useEffect)(() => {
		setOpen(false);
	}, [pathname]);
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SignedIn, { children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
								to: "/mis-anuncios",
								className: cn("text-sm font-medium transition-colors", pathname.startsWith("/mis-anuncios") ? "text-fg" : "text-muted hover:text-fg"),
								children: "Mis anuncios"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
								to: "/ofertas",
								className: cn("text-sm font-medium transition-colors", pathname.startsWith("/ofertas") ? "text-fg" : "text-muted hover:text-fg"),
								children: "Ofertas"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
								to: "/favoritos",
								className: cn("text-sm font-medium transition-colors", pathname.startsWith("/favoritos") ? "text-fg" : "text-muted hover:text-fg"),
								children: "Favoritos"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
								to: "/perfil",
								className: cn("text-sm font-medium transition-colors", pathname.startsWith("/perfil") ? "text-fg" : "text-muted hover:text-fg"),
								children: "Perfil"
							})
						] }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
...
function SiteFooter() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("footer", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "mx-auto flex max-w-6xl flex-col gap-8 px-4 py-12 sm:flex-row sm:items-start sm:justify-between",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: "Marketplace directo entre personas. Publica, oferta o permuta sin intermediarios ruidosos."
			...
			className: "flex flex-wrap items-center justify-center gap-4 border-t border-border py-4 text-xs text-subtle",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
					className: "inline-flex items-center gap-1",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Tag, { className: "size-3.5" }), " Compra"]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
					className: "inline-flex items-center gap-1",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(RefreshCw, { className: "size-3.5" }), " Permuta"]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
					className: "inline-flex items-center gap-1",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Heart, { className: "size-3.5" }), " Directo"]
				})
			]
		})]
	});
